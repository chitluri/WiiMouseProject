...
public class WiiMouseMeasure extends WiiRemoteAdapter
{
   ...
   * Constructor
   ***************************/
  public WiiMouseMeasure(WiiRemote remote) throws IOException
  {
    this.remote = remote;
  ...
  public static void main(String args[]) throws IllegalStateException, IOException
  {
    ...
    try
    {
      ...
      remote.addWiiRemoteListener(new WiiMouseMeasure(remote));
